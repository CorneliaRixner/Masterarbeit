...
# Eingabedatei
input_file = r"C:\Users\conri\Documents\FIT Master\5. Semester\Masterarbeit\03_Datensätze\Reddit-Beiträge\Covid 19\covid_19__kaggle_topic_modeling_full text.csv"
df = pd.read_csv(input_file)

print("Anzahl Zeilen:", len(df))
print("Null-Werte in comment_full_text:", df['comment_full_text'].isnull().sum())
...
token_list = []
for idx, text in enumerate(df['comment_full_text']):
    if idx % 100 == 0:
...
output_file_tokens = r"C:\Users\conri\Documents\FIT Master\5. Semester\Masterarbeit\03_Datensätze\Reddit-Beiträge\Covid 19\covid_19_kaggle_topic_modeling_tokenized.csv"
...
output_file_lemmas = r"C:\Users\conri\Documents\FIT Master\5. Semester\Masterarbeit\03_Datensätze\Reddit-Beiträge\Covid 19\covid_19_kaggle_topic_modeling_tokenized_lemmatized.csv"
...
output_file_no_stopwords = r"C:\Users\conri\Documents\FIT Master\5. Semester\Masterarbeit\03_Datensätze\Reddit-Beiträge\Covid 19\covid_19_kaggle_topic_modeling_tokenized_lemmatized_no_stopwords.csv"
...
stopword_file = r"C:\Users\conri\Documents\FIT Master\5. Semester\Masterarbeit\03_Datensätze\Reddit-Beiträge\Covid 19\spacy_stopwords.txt"
